...
(function() {
  App.chatrooms = App.cable.subscriptions.create("ChatroomsChannel", {
    ...
    received: function(data) {
      var active_chatroom, badge, current_room_link, message_html, message_html_0, subtitle, unread_count;
      ...
      return subtitle.html(data.last_message_str);
    },
...
(function() {
  App.user_common = App.cable.subscriptions.create("UserCommonChannel", {
    ...
    disconnected: function() {},
    received: function(data) {
      var chatroom_list, current_room_link, sidebar_chatroom_badge, sidebar_contact_badge;
      ...
      if (data.accepted) {
        return $("#friend-list-container ul").load(document.URL + ' #friend-list-container ul');
      }
    }
  });
...
(function() {
  ...
  handleVisiblityChange = function() {
    ...
    if ($strike.length > 0) {
      ...
      return $("#chatrooms-side-btn").load(document.URL + ' #chatrooms-side-btn');
    }
  };

  $(document).on('turbolinks:load', function() {
    return $(document).on("click", handleVisiblityChange);
  });

  $(document).on("turbolinks:load", function() {
    return $("#new_message").on("keypress", function(e) {
      var chatroom_id, content;
      if (e && e.keyCode === 13) {
        e.preventDefault();
        chatroom_id = $("[data-behavior='messages']").data("chatroom-id");
  ...
  $(document).on("turbolinks:load", function() {
    return $("#search-chatrooms-field").on('keypress', function(e) {
      var url;
      if (e && e.keyCode === 13) {
        url = $(this).attr("url");
        console.log(url);
